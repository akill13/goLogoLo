...
public enum AppPropertyType {
    ...
    RESIZE_DIALOG_HEADER_TEXT,
    RESIZE_DIALOG_TITLE_TEXT,
    RESIZE_HEIGHT_TEXT,
    RESIZE_WIDTH_TEXT,
    ...
    HAS_WELCOME_DIALOG,
    HAS_TOP_TOOLBAR,
    HAS_FILE_TOOLBAR, HAS_CLIPBOARD_TOOLBAR, HAS_UNDO_TOOLBAR, HAS_HELP_TOOLBAR, HAS_IMAGE_TOOLBAR,
    HAS_NEW, HAS_LOAD, HAS_CLOSE, HAS_SAVE, HAS_EXPORT, HAS_EXIT, HAS_HOME, HAS_SNAP, HAS_ZOOM_IN, HAS_ZOOM_OUT, HAS_RESIZE,
